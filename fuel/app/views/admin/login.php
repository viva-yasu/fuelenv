    ...
    <div class="col-md-3">
        ...
        <div class="form-group <?php echo !$val->error('email') ?: 'has-error' ?>">
            ...
            <?php if ($val->error('email')): ?>
                <span
                    class="control-label"><?php echo $val->error('email')->get_message('You must provide a username or email'); ?></span>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group <?php echo !$val->error('password') ?: 'has-error' ?>">
            ...
            <?php if ($val->error('password')): ?>
                <span
                    class="control-label"><?php echo $val->error('password')->get_message(':label cannot be blank'); ?></span>
            <?php endif; ?>
        </div>
